...
function alterego_scripts() {
	...
	wp_enqueue_script( 'alterego-tachyons', get_template_directory_uri() . '/css/tachyons.css' );

	wp_enqueue_script( 'alterego-custom', get_template_directory_uri() . '/css/custom.css' );
